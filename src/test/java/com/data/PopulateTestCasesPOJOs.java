...
import com.response.pojos.*;

public class PopulateTestCasesPOJOs {
	//TODOs: method code is similar and need to be merged
	
	/**
	 * This method will read sample test data i.e. "Set 1" list for particular API from input TestData.json
	 * And populate respective POJOs e.g. TestDataForSinglePhotoApi
	 * 
	 * Pls note multiple Sets in input json i.e. Set1, Set2 may map to single POJOs class TestDataForSinglePhotoApi.java
	 */
	public static List<TestDataForSinglePhotoApi> getSinglePhotoDataSet1(){
		...
		//System.out.println("JSON List for VerifySinglePhoto1 : "+ lsVerifySinglePhoto1);
		...
		//System.out.println("POJO List for TestDataForSinglePhotoApi : "+ listTestDataForSinglePhotoApi);
		return listTestDataForSinglePhotoApi;
	}
	
	
	/**
	 * This method will read sample test data i.e. "Set 2" list for particular API from input TestData.json
	 * And populate respective POJOs e.g. TestDataForSinglePhotoApi
	 * 
	 * Pls note Set 2 in input json is also corresponds to same API i.e. TestDataForSinglePhotoApi
	 */
	public static List<TestDataForSinglePhotoApi> getSinglePhotoDataSet2(){
		...
		//System.out.println("JSON List for VerifySinglePhoto2 : "+ lsVerifySinglePhoto2);
	...
	/**
	 * This method will read sample test data i.e. "Set 3" list for particular API from input TestData.json
	 * And populate respective POJOs e.g. TestDataForAlbumApi
	 * 
	 */
	public static List<TestDataForAlbumApi> getSingleAlbumDataSet1(){
		...
		//System.out.println("JSON List for VerifySingleAlbum1 : "+ lsVerifySingleAlbum1);
		...
		//System.out.println("POJO List for TestDataForAlbumApi : "+ listTestDataForAlbumApi);
...
//		
//		getSinglePhotoDataSet1();
//		getSinglePhotoDataSet2();
//		getSingleAlbumDataSet1();
//		
//	}
